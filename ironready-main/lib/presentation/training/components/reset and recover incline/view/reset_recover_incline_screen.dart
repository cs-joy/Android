...
class ResetRecoverInclineScreen extends StatefulWidget {
  const ResetRecoverInclineScreen({super.key});

  @override
  State<ResetRecoverInclineScreen> createState() => _ResetRecoverInclineScreenState();
}

class _ResetRecoverInclineScreenState extends State<ResetRecoverInclineScreen>
  ...
  void initState() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (timer) {
      if (seconds == 0) {
        ...
        setState(() {
          isCompleted = true;
          TrainingProgress.inclineBenchCompleted = true;
        });
      } else {
        setState(() => seconds--);
      }
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 15.h),
                        Text(
                          "Muscle Focused: Upper chest • Front shoulders",
                          style: getRegular400Style14(
                            fontSize: 14.sp,
                            color: ColorManager.whiteColor,
                          ),
                  ...
                  ResetInstructionBox(
                    instructions: const [
                      ...
                      "Shake it Out",
                      "Mind the Angle",
                      "Stay hydrated to maintain focus and energy.",
                    ],
                  ),
...
// import 'package:iron_ready/presentation/common widget/common_page_gradient.dart';
// import 'package:iron_ready/presentation/common widget/primary_button.dart';
// import 'package:iron_ready/presentation/common widget/reset_instruction_box.dart';
// import 'package:iron_ready/presentation/global%20state/training_progress.dart';
...
//   @override
//   State<ResetRecoverInclineScreen> createState() =>
//       _ResetRecoverInclineScreenState();
// }
...
//               child: Column(
//                 children: [
//                   CommonHeader(title: "reset & recover"),
...
//                         return CustomPaint(
//                           painter:
//                               _CircularPainter(progress: _controller.value),
//                           child: Center(
//                             child: Text(
//                               isCompleted ? "Completed" : "${seconds}s",
//                               style: getSemiBold600Style25(
