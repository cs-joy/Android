...
public class ListView_SpinnerActivity extends AppCompatActivity {
...
//        });
        ...
        deptSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ListView_SpinnerActivity.this, deptSpinner.getSelectedItem().toString() + " Selected", Toast.LENGTH_SHORT).show();
            }
        ...
        citiesList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ListView_SpinnerActivity.this, cities.get(position) + " Selected!", Toast.LENGTH_SHORT) .show();
            }
        });
